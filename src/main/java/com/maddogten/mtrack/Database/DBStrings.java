...
class DBStrings {
    ...
    static final String DBChangeTracker_isShowChangedSQL = "SELECT " + DBStrings.COLUMN_CHANGE_ID + " FROM " + DBStrings.TABLE_SHOWCHANGES + " WHERE " + COLUMN_SHOW_ID + "=?";
    static final String DBChangeTracker_doesUserContainChangeSQL = "SELECT " + COLUMN_USER_ID + " FROM " + DBStrings.TABLE_USERCHANGETRACKING + " WHERE " + DBStrings.COLUMN_USER_ID + "=? AND " + DBStrings.COLUMN_CHANGE_ID + "=?";
    ...
    static final String CREATE_PROGRAMSETTINGSTABLE = DBStrings.TABLE_PROGRAMSETTINGS + "(" +
            ...
            DBStrings.COLUMN_USERSHOWSETTINGSTABLEVERSION + " INTEGER NOT NULL, " +
            DBStrings.COLUMN_USEREPISODESETTINGSTABLEVERSION + " INTEGER NOT NULL, " +
